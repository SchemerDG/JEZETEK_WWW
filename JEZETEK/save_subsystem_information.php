...
$subsystem_information=$_POST['subsystem_information'];
...
$sql="UPDATE subsystems SET subsystems_name='".$subsystem_information['objename']."',description='".$subsystem_information['description']."'WHERE subsystems_id='".$subsystem_information['id']."'";
mysql_query($sql);
//输出
$arr=array();
